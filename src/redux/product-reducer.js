...
const TOGGLE_EXAMINATION = 'TOGGLE_EXAMINATION';
...
const addProductReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case TOGGLE_EXAMINATION: {
      return {
        ...state,
        setExamination: action.item,
      };
    }
    default:
      return state;
...
export const selectedItemsAC = (item) => ({
  type: ADD_PRODUCT_ITEM,
  item,
});
export const toggelExaminationAC = (item) => ({
  type: TOGGLE_EXAMINATION,
  item,
});
